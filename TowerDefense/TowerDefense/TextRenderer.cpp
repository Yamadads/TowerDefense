...
{
	shader = new Shader("Shaders/Font.vs", "Shaders/Font.frag");
	GLuint screenWidth = GameManager::screenWidth;
	GLuint screenHight = GameManager::screenHeight;
	...
	glm::mat4 projection = glm::ortho(0.0f, static_cast<GLfloat>(screenWidth), 0.0f, static_cast<GLfloat>(screenHight));
	shader->use();
